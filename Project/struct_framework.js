...
function run(){
    ...
    const node_arr = [1, 2, 3, 4, 5, 6, 7, 8, 9];
    const h_arr = [366, 374, 329, 244, 253, 178, 193, 98, 0];
    const u_arr = [1, 1, 1, 3, 5, 5, 6, 7, 8];
    const v_arr = [2, 3, 5, 4, 6, 7, 9, 8, 9];
    const g_arr = [75, 118, 140, 111, 99, 80, 211, 97, 101];
    const start = 1;
    const goal = 9;
